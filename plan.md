...
*   [x] **Asistente de Personalización de Consola:** Script `customize-terminal.ps1` y su cargador `.bat` para configurar estéticas (temas, fuentes, opacidad de WezTerm) y el banner de bienvenida de Bash, con reintentos robustos ante fallas.
