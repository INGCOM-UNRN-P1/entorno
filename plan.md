...
*   [x] Diseño y desarrollo de [install-lib.sh](file:///home/mrtin/dev/p1/entorno/bin/install-lib.sh) para compilar e instalar librerías externas de forma desatendida dentro del prefijo portable `/ucrt64`.
