...
*   **Compatibilidad con UCRT/Clang64:** Todas las compilaciones nativas de C deben realizarse utilizando el prefijo `/clang64` y el compilador Clang provisto en MSYS2.
