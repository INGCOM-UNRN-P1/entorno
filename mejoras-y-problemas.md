...
| 8 | **Ola pedagógica:** depuración lista (launch/tasks/clang-format) ✅, `backup`/`restaurar` ✅, higiene compartidas ✅, `doctor --fix` ✅, GitHub Classroom `clonar`+push ✅, corrector `verificar` ✅; restan `soporte` (50) | Medio |
